...
2. Gathers relevant POLYCLAW.md guideline files from the repository
3. Summarizes the pull request changes
4. Launches 4 parallel agents to independently review:
   - **Agents #1 & #2**: Audit for POLYCLAW.md compliance
...
- POLYCLAW.md compliance checking with explicit guideline verification
...
1. Missing error handling for OAuth callback (POLYCLAW.md says "Always handle OAuth errors")
...
3. Inconsistent naming pattern (src/conventions/POLYCLAW.md says "Use camelCase for functions")
...
- General quality issues (unless in POLYCLAW.md)
- Issues with lint ignore comments

## Installation

This plugin is included in the PolyClaw repository. The command is automatically available when using PolyClaw.

## Best Practices

### Using `/code-review`
- Maintain clear POLYCLAW.md files for better compliance checking
- Trust the 80+ confidence threshold - false positives are filtered
- Run on all non-trivial pull requests
- Review agent findings as a starting point for human review
- Update POLYCLAW.md based on recurring review patterns
...
- POLYCLAW.md files (optional but recommended for guideline checking)
...
- Make POLYCLAW.md more specific about what matters
...
- **Write specific POLYCLAW.md files**: Clear guidelines = better reviews
- **Include context in PRs**: Helps agents understand intent
- **Use confidence scores**: Issues ≥80 are usually correct
- **Iterate on guidelines**: Update POLYCLAW.md based on patterns
...
### Agent architecture
- **2x POLYCLAW.md compliance agents**: Redundancy for guideline checks
...
- For POLYCLAW.md issues: verifies guideline explicitly mentions it
