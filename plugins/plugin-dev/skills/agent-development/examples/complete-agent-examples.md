...
3. Check adherence to project best practices and coding standards from POLYCLAW.md
...
5. **Best Practices**:
   - Follow project-specific standards from POLYCLAW.md
...
- Missing context (no POLYCLAW.md): Apply general best practices
