...
Use this template to generate agents using PolyClaw with the agent creation system prompt.
...
Send this to PolyClaw (with the agent-creation-system-prompt loaded):
...
### Step 3: PolyClaw Returns JSON

PolyClaw will return:
...
Tell PolyClaw when the agent should activate:
...
- **Comprehensive**: PolyClaw includes edge cases and quality checks
