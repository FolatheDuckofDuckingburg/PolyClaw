...
assistant: "[How PolyClaw should respond before triggering]"
<commentary>
[Explanation of why this agent should be triggered in this scenario]
</commentary>
assistant: "[How PolyClaw triggers the agent - usually 'I'll use the [agent-name] agent...']"
</example>
```
...
**Purpose:** Show what PolyClaw says before launching the agent
...
**Purpose:** Show how PolyClaw invokes the agent
...
- Show PolyClaw using Agent tool
