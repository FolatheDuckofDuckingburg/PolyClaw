...
This is the exact system prompt used by PolyClaw's agent generation feature, refined through extensive production use.
...
3. **Architect Comprehensive Instructions**: Develop a system prompt that:
   ...
   - Aligns with project-specific coding standards and patterns from POLYCLAW.md
...
- Follow project documentation standards from POLYCLAW.md
```
...
The prompt specifically mentions using POLYCLAW.md context:
...
2. Feed to PolyClaw with this system prompt
...
This provides AI-assisted agent generation following proven patterns from PolyClaw's internal implementation.
