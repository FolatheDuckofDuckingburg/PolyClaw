...
**Important:** All examples below are written as instructions FOR PolyClaw (agent consumption), not messages TO users. Commands tell PolyClaw what to do, not tell users what will happen.

## Example 1: Code Review Command

**File:** `.polyclaw/commands/review.md`
...
**File:** `.polyclaw/commands/security-review.md`
...
**File:** `.polyclaw/commands/test-file.md`
...
**File:** `.polyclaw/commands/document.md`
...
**File:** `.polyclaw/commands/git-status.md`
...
**File:** `.polyclaw/commands/deploy.md`
...
**File:** `.polyclaw/commands/compare-files.md`
...
**File:** `.polyclaw/commands/quick-fix.md`
...
**File:** `.polyclaw/commands/research.md`
...
**File:** `.polyclaw/commands/explain.md`
