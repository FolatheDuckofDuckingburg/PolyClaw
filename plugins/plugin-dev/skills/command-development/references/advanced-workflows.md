...
Deployment state saved to `.polyclaw/deployment-state.local.md`:
...
Reading deployment state from `.polyclaw/deployment-state.local.md`...
...
```markdown
.polyclaw/plugin-name-workflow.local.md:
...
Reading workflow state from .polyclaw/plugin-name-workflow.local.md...

Current stage: @.polyclaw/plugin-name-workflow.local.md
...
State file: @.polyclaw/plugin-name-workflow.local.md
...
Creating: .polyclaw/feature-complete.flag
...
if [ -f .polyclaw/feature-complete.flag ]; then
...
if [ -f .polyclaw/deployment.lock ]; then
...
!`validate.sh`
echo "checkpoint:validation" >> .polyclaw/deployment-checkpoints.log

## Checkpoint 2: Build
!`build.sh`
echo "checkpoint:build" >> .polyclaw/deployment-checkpoints.log

## Checkpoint 3: Deploy
!`deploy.sh`
echo "checkpoint:deploy" >> .polyclaw/deployment-checkpoints.log
...
Written to .polyclaw/deployment-state.local.md
...
Reading state: @.polyclaw/deployment-state.local.md
...
rm .polyclaw/deployment-state.local.md
