...
**Purpose:** Specify which PolyClaw model executes the command
...
- PolyClaw can invoke programmatically
...
**Best practices:**
- Use sparingly (limits PolyClaw's autonomy)
...
**Invalid model name:**
```yaml
model: gpt4  # ❌ Not a valid PolyClaw model
```
