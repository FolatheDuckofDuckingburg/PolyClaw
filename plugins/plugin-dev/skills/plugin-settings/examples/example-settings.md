...
**.polyclaw/experimental-features.local.md:**
...
# Read settings
FRONTMATTER=$(sed -n '/^---$/,/^---$/{ /^---$/d; p; }' ".polyclaw/my-plugin.local.md")
...
```bash
# Edit settings
vim .polyclaw/my-plugin.local.md
...
Changes require PolyClaw restart - hooks can't be hot-swapped.
