...
# Validates .polyclaw/plugin-name.local.md structure
...
if [ $# -eq 0 ]; then
  ...
  echo "  - Field format"
  echo ""
  echo "Example: $0 .polyclaw/my-plugin.local.md"
  exit 1
fi
...
echo ""
echo "Reminder: Changes to this file require restarting PolyClaw"
exit 0
