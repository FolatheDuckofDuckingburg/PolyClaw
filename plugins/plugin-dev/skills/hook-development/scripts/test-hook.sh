...
# Set up environment
export POLYCLAW_PROJECT_DIR="${POLYCLAW_PROJECT_DIR:-/tmp/test-project}"
export POLYCLAW_PLUGIN_ROOT="${POLYCLAW_PLUGIN_ROOT:-$(pwd)}"
export POLYCLAW_ENV_FILE="${POLYCLAW_ENV_FILE:-/tmp/test-env-$$}"

if [ "$VERBOSE" = true ]; then
  echo "Environment:"
  echo "  POLYCLAW_PROJECT_DIR=$POLYCLAW_PROJECT_DIR"
  echo "  POLYCLAW_PLUGIN_ROOT=$POLYCLAW_PLUGIN_ROOT"
  echo "  POLYCLAW_ENV_FILE=$POLYCLAW_ENV_FILE"
  echo ""
fi
...
if [ -f "$POLYCLAW_ENV_FILE" ]; then
  echo ""
  echo "Environment file created:"
  cat "$POLYCLAW_ENV_FILE"
  rm -f "$POLYCLAW_ENV_FILE"
fi
