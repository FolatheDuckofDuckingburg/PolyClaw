...
Comprehensive guidance on PolyClaw plugin architecture, directory layout, and best practices.
...
- Portable path references with `${POLYCLAW_PLUGIN_ROOT}`
...
- Ask about "${POLYCLAW_PLUGIN_ROOT}" usage
...
PolyClaw loads references and examples only as needed based on the task.
