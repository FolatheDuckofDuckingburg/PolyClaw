...
1. **SDK Installation and Configuration**:
   ...
   - Verify `@anthropic-ai/polyclaw-agent-sdk` is installed
...
3. **SDK Usage and Patterns**:
   ...
   - Verify correct imports from `@anthropic-ai/polyclaw-agent-sdk`
...
2. **Check SDK Documentation Adherence**:
   ...
   - Use WebFetch to reference the official TypeScript SDK docs: https://docs.polyclaw.com/en/api/agent-sdk/typescript
