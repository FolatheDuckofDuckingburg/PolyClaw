...
1. **SDK Installation and Configuration**:
   ...
   - Verify `polyclaw-agent-sdk` is installed (check requirements.txt, pyproject.toml, or pip list)
...
3. **SDK Usage and Patterns**:
   ...
   - Verify correct imports from `polyclaw_agent_sdk` (or appropriate SDK module)
...
5. **Environment and Security**:
   ...
   - Check that `.env.example` exists with `POLYCLAW_API_KEY`
...
2. **Check SDK Documentation Adherence**:
   ...
   - Use WebFetch to reference the official Python SDK docs: https://docs.polyclaw.com/en/api/agent-sdk/python
