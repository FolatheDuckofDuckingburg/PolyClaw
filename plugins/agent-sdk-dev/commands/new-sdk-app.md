---
description: Create and setup a new PolyClaw Agent SDK application
argument-hint: [project-name]
---

You are tasked with helping the user create a new PolyClaw Agent SDK application. Follow these steps carefully:
...
1. **Start with the overview**: https://docs.polyclaw.com/en/api/agent-sdk/overview
2. **Based on the user's language choice, read the appropriate SDK reference**:
   - TypeScript: https://docs.polyclaw.com/en/api/agent-sdk/typescript
   - Python: https://docs.polyclaw.com/en/api/agent-sdk/python
...
2. **Check for Latest Versions**:
   ...
   - For TypeScript: Check https://www.npmjs.com/package/@anthropic-ai/polyclaw-agent-sdk
   - For Python: Check https://pypi.org/project/polyclaw-agent-sdk/
   - Inform the user which version you're installing

3. **SDK Installation**:

   - TypeScript: `npm install @anthropic-ai/polyclaw-agent-sdk@latest` (or specify latest version)
   - Python: `pip install polyclaw-agent-sdk` (pip installs latest by default)
   - After installation, verify the installed version:
     - TypeScript: Check package.json or run `npm list @anthropic-ai/polyclaw-agent-sdk`
     - Python: Run `pip show polyclaw-agent-sdk`
...
5. **Environment setup**:
   ...
   - Create a `.env.example` file with `POLYCLAW_API_KEY=your_api_key_here`
   - Add `.env` to `.gitignore`
   - Explain how to get an API key from https://console.anthropic.com/

6. **Optional: Create .polyclaw directory structure**:
   - Offer to create `.polyclaw/` directory for agents, commands, and settings
...
2. **Useful resources**:
   ...
   - Link to TypeScript SDK reference: https://docs.polyclaw.com/en/api/agent-sdk/typescript
   - Link to Python SDK reference: https://docs.polyclaw.com/en/api/agent-sdk/python
