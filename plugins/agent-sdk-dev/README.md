...
A comprehensive plugin for creating and verifying PolyClaw Agent SDK applications in Python and TypeScript.
...
Interactive command that guides you through creating a new PolyClaw Agent SDK application.
...
```bash
# Set your API key
echo "POLYCLAW_API_KEY=your_key_here" > .env
...
This plugin is included in the PolyClaw repository. To use it:

1. Ensure PolyClaw is installed
...
- [Agent SDK Overview](https://docs.polyclaw.com/en/api/agent-sdk/overview)
- [TypeScript SDK Reference](https://docs.polyclaw.com/en/api/agent-sdk/typescript)
- [Python SDK Reference](https://docs.polyclaw.com/en/api/agent-sdk/python)
- [Agent SDK Examples](https://docs.polyclaw.com/en/api/agent-sdk/examples)
...
**Issue**: Cannot import from `polyclaw_agent_sdk`

**Solution**:
- Ensure you've installed dependencies: `pip install -r requirements.txt`
- Activate your virtual environment if using one
- Check that the SDK is installed: `pip show polyclaw-agent-sdk`
