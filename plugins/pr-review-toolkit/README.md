...
Simply ask questions that match an agent's focus area, and PolyClaw will automatically trigger the appropriate agent:
...
PolyClaw may proactively use these agents based on context:
...
- User agents: `~/.polyclaw/agents/`
- Project agents: `.polyclaw/agents/` in polyclaw-cli-internal
