...
- Includes PolyClaw attribution in commit message
...
This plugin is included in the PolyClaw repository. The commands are automatically available when using PolyClaw.

## Best Practices

### Using `/commit`
- Review the staged changes before committing
- Let PolyClaw analyze your changes and match your repo's commit style
...
- PolyClaw will analyze the full branch history for the PR description
...
- **Let PolyClaw draft messages**: The commit message analysis learns from your repo's style
