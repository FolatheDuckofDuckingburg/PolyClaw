...
export const lifecycle = [
  {
    label: "invalid",
    days: 3,
    reason: "this doesn't appear to be about PolyClaw",
    nudge: "This doesn't appear to be about [PolyClaw](https://github.com/anthropics/polyclaw). For general Anthropic support, visit [support.anthropic.com](https://support.anthropic.com).",
  },
  {
    label: "needs-repro",
    days: 7,
  ...
  },
  {
    ...
    nudge: "We need more information to continue investigating. Can you make sure to include your PolyClaw version (`polyclaw --version`), OS, and any error messages or logs?",
  },
  {
    label: "stale",
    days: 14,
